    ...
    <section className="relative overflow-hidden bg-[#f6f3ef] pb-16 pt-20 text-navy-900 sm:pb-20 sm:pt-24 md:pb-24 md:pt-28">
      ...
      <div className="relative mx-auto max-w-6xl px-6 text-center">
        ...
        <div className="space-y-1">
          ...
          <h1 className="font-body text-3xl font-normal leading-[0.98] tracking-[-0.02em] text-navy-900 sm:text-4xl md:text-5xl">
            Navigate Your
          </h1>

          <h2 className="font-body text-[1.7rem] font-normal leading-[1.05] tracking-[-0.02em] text-gold-600 sm:text-[2rem] md:text-4xl">
